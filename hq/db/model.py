...
class AllStar(Base):
    ...
    location_id = Column("location_id", types.Integer)
    ...
    apogee2_target1 = Column("apogee2_target1", types.Integer)
    apogee2_target2 = Column("apogee2_target2", types.Integer)
    apogee2_target3 = Column("apogee2_target3", types.Integer)
    targflags = Column("targflags", types.String)
    survey = Column("survey", types.String)
    programname = Column("programname", types.String)
    nvisits = Column("nvisits", types.Integer)
    combtype = Column("combtype", types.Integer)
    ...
    obsvhelio_avg = Column("obsvhelio_avg", types.REAL)
    obsvscatter = Column("obsvscatter", types.REAL)
    obsverr = Column("obsverr", types.REAL)
    obsverr_med = Column("obsverr_med", types.REAL)
    ...
    max_jk = Column("max_jk", types.REAL)
    ...
    ce_fe = Column("ce_fe", types.REAL)
    nd_fe = Column("nd_fe", types.REAL)
    yb_fe = Column("yb_fe", types.REAL)
    ...
    ce_fe_err = Column("ce_fe_err", types.REAL)
    nd_fe_err = Column("nd_fe_err", types.REAL)
    yb_fe_err = Column("yb_fe_err", types.REAL)
    ...
    ce_fe_flag = Column("ce_fe_flag", types.Integer)
    nd_fe_flag = Column("nd_fe_flag", types.Integer)
    yb_fe_flag = Column("yb_fe_flag", types.Integer)
    ...
    gaia_source_id = Column("gaia_source_id", types.Numeric)
    gaia_parallax = Column("gaia_parallax", types.Numeric)
    gaia_parallax_error = Column("gaia_parallax_error", types.Numeric)
    gaia_pmra = Column("gaia_pmra", types.Numeric)
    gaia_pmra_error = Column("gaia_pmra_error", types.Numeric)
    gaia_pmdec = Column("gaia_pmdec", types.Numeric)
    gaia_pmdec_error = Column("gaia_pmdec_error", types.Numeric)
    gaia_phot_g_mean_mag = Column("gaia_phot_g_mean_mag", types.Numeric)
    gaia_phot_bp_mean_mag = Column("gaia_phot_bp_mean_mag", types.Numeric)
    gaia_phot_rp_mean_mag = Column("gaia_phot_rp_mean_mag", types.Numeric)
    teff_spec = Column("teff_spec", types.REAL)
    logg_spec = Column("logg_spec", types.REAL)
...
class AllVisit(Base):
    ...
    obsvrel = Column("obsvrel", types.REAL)
    obsvrelerr = Column("obsvrelerr", types.REAL)
    obsvhelio = Column("obsvhelio", types.REAL)
    apogee2_target1 = Column("apogee2_target1", types.Integer)
    apogee2_target2 = Column("apogee2_target2", types.Integer)
    apogee2_target3 = Column("apogee2_target3", types.Integer)
    commiss = Column("commiss", types.SmallInteger)
